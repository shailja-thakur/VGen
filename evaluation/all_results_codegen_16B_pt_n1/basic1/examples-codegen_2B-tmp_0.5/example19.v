...
// assign out to in
wire_assign2( input in, output out );

module wire_assign3( input in, output out );
// assign out to in
wire_assign3( input in, output out );

module wire_assign4( input in, output out );
// assign out to in
wire_assign4( input in, output out );

module wire_assign5( input in, output out );
// assign out to in
wire_assign5( input in, output out );

module wire_assign6( input in, output out );
// assign out to in
wire_assign6( input in, output out );
